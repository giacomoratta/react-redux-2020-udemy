...
class StreamForm extends React.Component {
  ...
  onSubmit = (formValues) => {
    ...
    this.props.onSubmit(formValues); // see connect()
  }
  ...
  render() {
    ...
    return (
      ...
      // #2 - this.props.initialValues is a special property of redux-form
      //    - see StreamEdit.js for its usage
...
export default reduxForm({
  form: 'StreamForm', // name for this specific form
